...
#[no_mangle] 
pub extern "C" fn voxel_color_r(voxel: &VoxelColors, index: usize) -> usize {
    voxel.get_color(index, &RGBA::R).unwrap_or(0) as usize
}
#[no_mangle] 
pub extern "C" fn voxel_color_g(voxel: &VoxelColors, index: usize) -> usize {
    voxel.get_color(index, &RGBA::G).unwrap_or(0) as usize
}
#[no_mangle] 
pub extern "C" fn voxel_color_b(voxel: &VoxelColors, index: usize) -> usize {
    voxel.get_color(index, &RGBA::B).unwrap_or(0) as usize
}
#[no_mangle] 
pub extern "C" fn voxel_color_a(voxel: &VoxelColors, index: usize) -> usize {
    voxel.get_color(index, &RGBA::A).unwrap_or(0) as usize
}
#[no_mangle] 
